...
check_button = Button(image=my_image1, highlightthickness=0, command=generate_word)
check_button.grid(row=1, column=1)
my_image2 = PhotoImage(file="./images/wrong.png")
wrong_button = Button(image=my_image2, highlightthickness=0, command=generate_word)
